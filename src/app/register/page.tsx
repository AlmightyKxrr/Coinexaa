        ...
        <section className="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-24 bg-surface-dim">
          <div className="w-full max-w-md">
            ...
            <div className="flex gap-4 mb-8 bg-surface-container-low p-1 rounded-lg">
              <Link href="/login" className="flex-1 py-2 text-sm text-center font-medium text-on-surface-variant hover:text-on-surface transition-all">Login</Link>
              <Link href="/register" className="flex-1 py-2 text-sm font-bold text-center rounded-md bg-surface-bright text-on-surface shadow-sm transition-all">Register</Link>
            </div>
